...
func (c *imageProcessingServiceV1Client) Validate(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
...
func (UnimplementedImageProcessingServiceV1Server) Validate(context.Context, *ValidateRequest) (*ValidateResponse, error) {
